 ...
 * This file demonstrates how to integrate Cryptoraft with a web frontend
 */

// For React/Vue/Angular applications
export class CryptoraftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new CryptoraftClient(provider, contractAddress);
